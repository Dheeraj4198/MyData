...
export class AuthService {
  ...
  Login(data: any) {
    return this.http.post(this.baseApiUrl + 'api/Auth/login', data);
  }
  HaveAccess() {
  ...
  MobileLogin(data: any) {
    return this.http.post(this.baseApiUrl + 'api/Auth/send-otp', data);
  }

  verifyLogin(data: any) {
    return this.http.post(this.baseApiUrl + 'api/Auth/verify-otp', data);
  }
